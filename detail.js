const cartLink = document.getElementById('cart-link3');
        const sidebar = document.getElementById('sidebar3');

        cartLink.addEventListener('click', () => {
        
            if (sidebar.classList.contains('sidebar-hidden3')) {
                sidebar.classList.remove('sidebar-hidden3');
            } else {
                sidebar.classList.add('sidebar-hidden3');
            }
        });    
